...
## Part 1: Inference on Churn Characteristics
Some questions relevant for the task are:
1. Which factors increase the odds of a customer churning the most?
2. Does credit score or account balance plays a role to influence the odds of churning?
3. Are there any existing interactions in the dataset?
